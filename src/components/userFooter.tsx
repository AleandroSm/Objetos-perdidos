        ...
        <footer className="flex justify-center items-center py-2 mt-auto">
            <section className="max-w-3xl w-full grid grid-cols-3">
                ...
                <article>
                    ...
                    <ul>
                        <li className="mb-2">
                            <Link href={'/terms/privacy'} className="hover:text-blue-400">Aviso de privacidad</Link>
                        </li>
                        <li className="mb-2">
                            <Link href={'/terms/termsConditions'} className="hover:text-blue-400">Términos y Condiciones</Link>
                        </li>
                        <li className="mb-2">
                        <Link href={'/terms/cookiesPol'} className="hover:text-blue-400">Politicas de cookies</Link>                            
                        </li>
                    </ul>
                </article>
                <article>
